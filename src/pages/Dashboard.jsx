          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
            {sections.map((sec, i) => (
              <motion.div
                ...
                className="p-6 rounded-2xl bg-black/40 border border-[#65BDB1]/30 shadow-[0_0_20px_#65BDB155] backdrop-blur-xl 
                          hover:scale-105 hover:shadow-[0_0_25px_pink] transition transform cursor-pointer"
              >
                <h2 className="text-xl font-semibold mb-2 text-[#65BDB1]">{sec.title}</h2>
                <p className="text-gray-300 text-sm">Ir a la sección de {sec.title.toLowerCase()}.</p>
              </motion.div>
            ))}
          </div>
        </main>
